      ...
      <div class="shell header-shell">
        ...
        <div class="nav-shell">
          ...
          <nav class="site-nav" aria-label="Primary navigation">
            ${navItems.map((item) => renderNavItem(item, activePage, isApiDetail || isStaticPage)).join("")}
          </nav>
          ${isApiDetail || isStaticPage ? `<a class="btn btn-primary nav-cta" href="/#contact">Request RFQ</a>` : pageButton("Request RFQ", "contact", "btn btn-primary nav-cta")}
        </div>
      </div>
    </header>`;
}
        ...
        <div class="shell footer-bottom__inner">
          ...
          <div class="footer-social-icons" aria-label="Social and contact links">
            ...
            <a href="#" target="_blank" rel="noreferrer" aria-label="X / Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
